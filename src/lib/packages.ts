...
export const privateTiers: PackageTier[] = [
  {
    ...
    discount: "5% off",
    prices: [
      { label: "60 minutes", total: "$1,596", per: "$133 / lesson", hourlyRate: "$133/hour" },
      { label: "90 minutes", total: "$2,337", per: "$194.75 / lesson", hourlyRate: "$129/hour" },
    ],
    save: "save $123 on 90-min",
    popular: false,
  ...
  },
  {
    ...
    discount: "10% off",
    prices: [
      { label: "60 minutes", total: "$3,024", per: "$126 / lesson", hourlyRate: "$126/hour" },
      { label: "90 minutes", total: "$4,428", per: "$184.50 / lesson", hourlyRate: "$123/hour" },
    ],
    save: "save $492 on 90-min",
    popular: true,
  ...
  },
  {
    ...
    discount: "15% off",
    prices: [
      { label: "60 minutes", total: "$4,284", per: "$119 / lesson", hourlyRate: "$119/hour" },
      { label: "90 minutes", total: "$6,273", per: "$174.25 / lesson", hourlyRate: "$116/hour" },
    ],
    save: "save $1,107 on 90-min",
    popular: false,
