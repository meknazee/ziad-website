  ...
  return <div className="min-h-screen bg-background">
      ...
      <section id="contact" className="py-16 px-6 bg-muted/30">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 leading-relaxed">contact me if you need help building digital tools </p>
          <div className="flex justify-center space-x-6">
            ...
            <a href="https://signal.me/#eu/ziad" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 border border-primary text-primary px-6 py-3 rounded hover:bg-primary/10 transition-colors duration-200 font-medium">
